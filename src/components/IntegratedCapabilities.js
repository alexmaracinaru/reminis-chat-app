...
const IntegratedCapabilities = () => {
  return (
    <section className="bg-white px-6 md:px-36 md:pt-48 pt-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col space-y-6">
            ...
            <div className="absolute inset-0 flex items-center justify-start pt-4 px-4 md:pt-36 md:pl-12 lg:pt-6 lg:pl-4 xl:pt-12 xl:pl-8  2xl:pt-16  2xl:pl-12 2xl:pb-0">
              <div className="bg-white bg-opacity-10 border border-white border-opacity-40 backdrop-blur-md rounded-lg">
                <div className="text-white text-left md:p-6 p-4 lg:p-4 xl:p-8 2xl:p-12">
                  <h3 className="2xl:text-7xl md:text-6xl lg:text-4xl text-3xl font-light">
                    01
                  </h3>
          ...
          <p className="text-2xl text-gray-800 max-w-[550px]">
            Your digital presence is your audience's first interaction. We
            design and optimize websites to create a strong first impression,
          ...
          <div className="space-y-2">
            ...
            <ul className="list-none">
              <li className="text-gray-500 max-w-[450px]">
                / Amplifies your Brand Strategy by establishing consistent
                messaging across all touchpoints.
              </li>
              <li className="text-gray-500 max-w-[450px]">
                / Supports Go-To-Market strategies with a robust online
                footprint.
              </li>
            </ul>
          </div>
        ...
        <div className="flex flex-col space-y-6">
          ...
          <p className="text-2xl text-gray-800 max-w-[550px]">
            While your website sets the stage, your product must meet user
            needs. We transform your MVP into a scalable, polished product
            through intuitive, iterative design improvements.
          </p>
          <div className="space-y-2">
            <p className="text-xs text-gray-500 bg-gray-100 w-fit rounded-lg px-2 py-1">
              How it fits
            ...
            <ul className="list-none">
              <li className="text-gray-500 max-w-[450px]">
                / Enhances Product-Market Fit by translating user feedback into
                intuitive, user-centered designs.
              </li>
              <li className="text-gray-500 max-w-[450px]">
                / Prepares your product fo GTM efforts by ensuring it aligns
                with market-ready standards.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col space-y-6">
          ...
          <p className="text-2xl text-gray-800 max-w-[550px]">
            Clear, impactful communication is key to standing out. We develop
            strategies to deliver your message to the right audience, at the
        ...
        <div className="flex flex-col space-y-6">
          ...
          <p className="text-2xl text-gray-800 max-w-[550px]">
            Great content drives trust, engagement, and growth. We create
            actionable content strategies to keep your audience informed and
            inspired.
          </p>
          <div className="space-y-2">
            <p className="text-xs text-gray-500 bg-gray-100 w-fit rounded-lg px-2 py-1">
          ...
          <ul className="list-none">
            <li className="text-gray-500 max-w-[450px]">
              / Strengthens GTM Strategy with compelling storytelling for
              acquisition and retention.
            </li>
            <li className="text-gray-500 max-w-[450px]">
              / Builds a strong online presence that supports your brand and
              product and supports growth by creating scalable content
            </li>
          </ul>
        </div>
      </div>
